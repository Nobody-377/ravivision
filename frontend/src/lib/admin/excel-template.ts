  ...
  const templateData = [
    {
      ...
      'Stock': 12,
      'Status': 'ACTIVE',
      'Best Seller (Yes/No)': 'Yes',
      'Featured (Yes/No)': 'Yes',
      'Image URLs (comma separated)': 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e',
    ...
    {
      'Product Name': 'Crompton Energion 1200mm BLDC Ceiling Fan with Remote',
      'Brand': 'Crompton',
      'Category': 'Fans',
      'Subcategory': 'Ceiling Fan',
      'SKU': 'CRM-FAN1200-005',
      'Selling Price (INR)': 3290,
      'MRP (INR)': 5100,
      'Stock': 25,
      'Status': 'ACTIVE',
      'Best Seller (Yes/No)': 'Yes',
